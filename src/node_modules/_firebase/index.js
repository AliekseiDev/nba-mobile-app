...
let actions = {
  ...
  async saveArticle(type, dataToSubmit) {
  ...
  async fetchTeams() {
    if (this._teams && this._teams.length) return this._teams;
  ...
  async findArticleById(type, param) {
  ...
  async findArticles(type, start = 0, amount = 3) {
